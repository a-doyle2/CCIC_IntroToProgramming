public class UI{
  ...
  */
  public void display(int citySize){
    ...
    text("Day: " + dayCount, citySize / 20, citySize - 25);
    
    // Replace the number 0 with an expression that contains the variable citSize
    text("Current Infections: " + infected, citySize / 4 + citySize / 20, citySize - 25);
    
    text("Recovered: " + recovered, citySize / 2 + citySize / 10, citySize - 25);
    
    // Replace the number 0 with an expression that contains the variable citSize
    text("Dead: " + dead, 3 * citySize / 4 + 3 * citySize / 20, citySize - 25);
  }
}
